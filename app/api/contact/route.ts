...
export async function POST( req: NextRequest ){
    ...
    try {
        ...
        const { name, email, companyName, Infrastructure, Primarypoint, Datavolume, message} = body;

        if(!name || !email || !companyName || !Infrastructure || !Primarypoint || !Datavolume || !message){
            ...
            `
                <div style="background: radial-gradient(circle at top left, #1a1a2e, #0a0a0a); color: #e0e0e0; font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; padding: 40px; border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 24px; max-width: 600px; margin: 20px auto; box-shadow: 0 20px 50px rgba(0,0,0,0.7);">
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 30px;">
                        ...
                        <p style="color: #9d7aff; font-size: 13px; margin: 4px 0 0 0; text-transform: uppercase; font-weight: 800; letter-spacing: 1px;">Clickhouse Landing Page</p>
                        </div>
                    </div>
                    ...
                    <div style="display: flex; gap: 8px; flex-wrap: wrap; margin-bottom: 30px;">
                        ...
                        <span style="color: #00e676; margin-right: 6px;">●</span> <span style="color: #aaa;">Deployment:</span> <strong style="color: #eee;">${Infrastructure}</strong>
                        </div>
                        <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); padding: 8px 14px; border-radius: 100px; font-size: 12px;">
                        <span style="color: #00e676; margin-right: 6px;">●</span> <span style="color: #aaa;">Cloud:</span> <strong style="color: #eee;">${Primarypoint}</strong>
                        </div>
                        <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); padding: 8px 14px; border-radius: 100px; font-size: 12px;">
                        <span style="color: #00e676; margin-right: 6px;">●</span> <span style="color: #aaa;">GPU:</span> <strong style="color: #eee;">${Datavolume}</strong>
                        </div>
                    </div>
                    ...
                    <div style="margin-top: 40px; padding-top: 20px; border-top: 1px solid rgba(255,255,255,0.05); text-align: center;">
                        ...
                        SECURED NOTIFICATION // <strong style="color: #777;">Click House</strong>
                        </p>
                    </div>
                </div>
            `
            ...
            `
                ...
                <div class="content">
                    ...
                    <div class="message-box">
                        We’ve successfully received your application!clickhouse@quantrail-data.com is excited to review your profile and will get back to you soon.
                    </div>
                </div>
                <div class="footer">
                    This message was sent via your ClickHouse Landing page contact form.
                </div>
                </div>
                </body>
                </html>
